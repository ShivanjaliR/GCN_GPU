...
output_folder = './input_separate_files/'

output_file = './output_separate_files/output.txt'
dataset_details = './output_separate_files/DatasetDetails.csv'
text_graph_file_name = './output_separate_files/Text Graph'
text_graph_name = 'Text Graph'
training_loss_plot_file_name = './output_separate_files/Training Loss per epochs'
training_loss_plot_name = 'Training Loss per epochs'
training_accuracy_plot_file_name = './output_separate_files/Training Accuracy per epochs'
training_precision_plot_file_name = './output_separate_files/Precision Trained dataset'
training_recall_plot_file_name = './output_separate_files/Recall Trained dataset'
training_f1score_plot_file_name = './output_separate_files/F1 score of Trained dataset'
...
neural_ntw_details = './output_separate_files/neural_ntw_details.csv'

testing_precision_plot_file_name = './output_separate_files/Precision untrained dataset'
testing_recall_plot_file_name = './output_separate_files/Recall untrained dataset'
testing_f1score_plot_file_name = './output_separate_files/F1 score untrained dataset'
...
testing_loss_plot_file_name = './output_separate_files/Testing Loss per epochs'
testing_loss_plot_name = 'Testing Loss per epochs'
testing_accuracy_plot_file_name = './output_separate_files/Testing Accuracy per epochs'
testing_accuracy_plot_name = 'Testing Accuracy per epochs'

combined_accuracy_plot_file_name = './output_separate_files/Combined Accuracy per epochs'
combined_accuracy_plot_name = 'Trained and Un-trained Node accuracy'

tf_idf_histogram = './output_separate_files/TF-IDF Histogram'
pmi_histogram = './output_separate_files/PMI Histogram'
...
first_layer_before_training_for_training_dataset_file_name = './output_separate_files/Training Classification First Layer Before Training'
first_layer_before_training_for_testing_dataset_file_name = './output_separate_files/Testing Classification First Layer Before Training'
...
first_layer_after_training_for_training_dataset_file_name = './output_separate_files/Classification of First Trained Layer weights After Training'
first_layer_after_training_for_testing_dataset_file_name = './output_separate_files/Classification of First Un-trained Layer weights After Training'

categories_for_classification = 'Categories of documents'

graph_details = './output_separate_files/GraphDetails.csv'

model_digram = './output_separate_files/gcn_model.png'

data_index_distribution = './output_separate_files/data_index_distribution'
label_not_selected_distribution = './output_separate_files/label_not_selected_distribution'
trained_confusion_matrix_file_name = './output_separate_files/trained_confusion_matrix'
untrained_confusion_matrix_file_name = './output_separate_files/untrained_confusion_matrix'

result_file = './output_separate_files/result.txt'
accuracy_file = './output_separate_files/prediction.txt'
