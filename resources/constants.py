...
summary_total_words = 'Total Number of Words in all documents'
summary_total_training_words = 'Total Number of Training Words in all documents'
...
all_label_file = 'all_label_file.pkl'
