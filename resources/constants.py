...
output_folder = './input_whole_dataset'

output_file = './output_whole_dataset/output.txt'
dataset_details = './output_whole_dataset/DatasetDetails.csv'
text_graph_file_name = './output_whole_dataset/Text Graph'
text_graph_name = 'Text Graph'
training_loss_plot_file_name = './output_whole_dataset/Training Loss per epochs'
training_loss_plot_name = 'Training Loss per epochs'
training_accuracy_plot_file_name = './output_whole_dataset/Training Accuracy per epochs'
training_precision_plot_file_name = './output_whole_dataset/Precision Trained dataset'
training_recall_plot_file_name = './output_whole_dataset/Recall Trained dataset'
training_f1score_plot_file_name = './output_whole_dataset/F1 score of Trained dataset'
...
neural_ntw_details = './output_whole_dataset/neural_ntw_details.csv'

testing_precision_plot_file_name = './output_whole_dataset/Precision untrained dataset'
testing_recall_plot_file_name = './output_whole_dataset/Recall untrained dataset'
testing_f1score_plot_file_name = './output_whole_dataset/F1 score untrained dataset'
...
testing_loss_plot_file_name = './output_whole_dataset/Testing Loss per epochs'
testing_loss_plot_name = 'Testing Loss per epochs'
testing_accuracy_plot_file_name = './output_whole_dataset/Testing Accuracy per epochs'
testing_accuracy_plot_name = 'Testing Accuracy per epochs'

combined_accuracy_plot_file_name = './output_whole_dataset/Combined Accuracy per epochs'
combined_accuracy_plot_name = 'Trained and Un-trained Node accuracy'

tf_idf_histogram = './output_whole_dataset/TF-IDF Histogram'
pmi_histogram = './output_whole_dataset/PMI Histogram'
...
first_layer_before_training_for_training_dataset_file_name = './output_whole_dataset/Training Classification First Layer Before Training'
first_layer_before_training_for_testing_dataset_file_name = './output_whole_dataset/Testing Classification First Layer Before Training'
...
first_layer_after_training_for_training_dataset_file_name = './output_whole_dataset/Classification of First Trained Layer weights After Training'
first_layer_after_training_for_testing_dataset_file_name = './output_whole_dataset/Classification of First Un-trained Layer weights After Training'

categories_for_classification = 'Categories of documents'

graph_details = './output_whole_dataset/GraphDetails.csv'

model_digram = './output_whole_dataset/gcn_model.png'

data_index_distribution = './output_whole_dataset/data_index_distribution'
label_not_selected_distribution = './output_whole_dataset/label_not_selected_distribution'
trained_confusion_matrix_file_name = './output_whole_dataset/trained_confusion_matrix'
untrained_confusion_matrix_file_name = './output_whole_dataset/untrained_confusion_matrix'

result_file = './output_whole_dataset/result.txt'
accuracy_file = './output_whole_dataset/prediction.txt'
