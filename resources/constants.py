...
output_folder = './input_560_2'

output_file = './output_560_2/output.txt'
dataset_details = './output_560_2/DatasetDetails.csv'
text_graph_file_name = './output_560_2/Text Graph'
text_graph_name = 'Text Graph'
training_loss_plot_file_name = './output_560_2/Training Loss per epochs'
training_loss_plot_name = 'Training Loss per epochs'
training_accuracy_plot_file_name = './output_560_2/Training Accuracy per epochs'
training_precision_plot_file_name = './output_560_2/Precision Trained dataset'
training_recall_plot_file_name = './output_560_2/Recall Trained dataset'
training_f1score_plot_file_name = './output_560_2/F1 score of Trained dataset'
...
neural_ntw_details = './output_560_2/neural_ntw_details.csv'

testing_precision_plot_file_name = './output_560_2/Precision untrained dataset'
testing_recall_plot_file_name = './output_560_2/Recall untrained dataset'
testing_f1score_plot_file_name = './output_560_2/F1 score untrained dataset'
...
testing_loss_plot_file_name = './output_560_2/Testing Loss per epochs'
testing_loss_plot_name = 'Testing Loss per epochs'
testing_accuracy_plot_file_name = './output_560_2/Testing Accuracy per epochs'
testing_accuracy_plot_name = 'Testing Accuracy per epochs'

combined_accuracy_plot_file_name = './output_560_2/Combined Accuracy per epochs'
combined_accuracy_plot_name = 'Trained and Un-trained Node accuracy'

tf_idf_histogram = './output_560_2/TF-IDF Histogram'
pmi_histogram = './output_560_2/PMI Histogram'
...
first_layer_before_training_for_training_dataset_file_name = './output_560_2/Training Classification First Layer Before Training'
first_layer_before_training_for_testing_dataset_file_name = './output_560_2/Testing Classification First Layer Before Training'
...
first_layer_after_training_for_training_dataset_file_name = './output_560_2/Classification of First Trained Layer weights After Training'
first_layer_after_training_for_testing_dataset_file_name = './output_560_2/Classification of First Un-trained Layer weights After Training'

categories_for_classification = 'Categories of documents'

graph_details = './output_560_2/GraphDetails.csv'

model_digram = './output_560_2/gcn_model.png'

data_index_distribution = './output_560_2/data_index_distribution'
label_not_selected_distribution = './output_560_2/label_not_selected_distribution'
trained_confusion_matrix_file_name = './output_560_2/trained_confusion_matrix'
untrained_confusion_matrix_file_name = './output_560_2/untrained_confusion_matrix'

result_file = './output_560_2/result.txt'
accuracy_file = './output_560_2/prediction.txt'

output_column_filename = 'File Name'
output_column_noOfWords = 'Number of Words in File'
output_column_noOfTrainingWords = 'Number of Training Words'
output_column_content = 'Content'
output_column_training_content = 'Training Content'
...
summary_column_avgWordCountForTraining = 'Average Number of training words from each document'
